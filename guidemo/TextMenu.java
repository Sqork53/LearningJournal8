...
public class TextMenu extends JMenu {
	...
	//I Tried but could  not figure out how to add the left.setSelected(true); here.
	//The program kept breaking and I dont know why
	...
	//When I was creating this method I had a hard time getting the buttons to select 
	//what I wanted them to select. I ended up adding a button group and making the default one be Left
	// It worked great
